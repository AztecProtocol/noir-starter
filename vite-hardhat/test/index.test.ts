...
// describe('It compiles noir program code, receiving circuit bytes and abi object - UltraPlonk', () => {
//   let noir: Noir;
...
describe('It compiles noir program code, receiving circuit bytes and abi object - UltraHonk', () => {
  let noir: Noir;
